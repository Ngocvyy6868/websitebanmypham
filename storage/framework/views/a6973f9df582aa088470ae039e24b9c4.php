                        ...
                        <div class="header__right">
                            <div class="header__right__auth">
                                <a>
                                    ...
                                    <a href="<?php echo e(route('admin')); ?>"><img src="<?php echo e(asset('img/admin-icon.png')); ?>"
                                            alt=""></a>
                                    <?php endif; ?>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($order->order_user); ?></td> <!-- Tên người đặt -->
                        <td><?php echo e(number_format($order->total_amount, 0, ',', ',')); ?>,000 VND</td>
                        <!-- Hiển thị tổng tiền -->
                        <td>
                            <span class="badge <?php echo e($order->status == 'pending' ? 'bg-warning' : 'bg-success'); ?>">
                                <?php echo e(ucfirst($order->status)); ?>

                            </span>
                        </td>
                        <td><?php echo e(\Carbon\Carbon::parse($order->create_at)->format('d/m/Y H:i')); ?></td>
                        <td>
                            <a href="<?php echo e(route('order.show', $order->order_id)); ?>" class="btn btn-primary btn-sm">Xem chi
                                tiết</a>
                        </td>
                    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\ngocvy\resources\views/order_complete.blade.php ENDPATH**/ ?>