...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="<?php echo e(url('/profile')); ?>"><img style="width:50%;" src="<?php echo e(asset ('img/profile.jpg')); ?>" alt=""></a>
        <ul>
            ...
            <li><a href="<?php echo e(url('/danh-sach-dat-hang')); ?>">Order</a></li>
            <li><a href="<?php echo e(url('/danh-sach-lien-he')); ?>">Contact</a></li>
            <li><a href="<?php echo e(url('/trang-chu')); ?>">Cửa Hàng</li>
        </ul>
    </div>
    <!-- Content -->
...
</html><?php /**PATH C:\xampp\htdocs\22662051_NguyenThiNgocVy\22662051_NguyenThiNgocVy_PhanCode\resources\views/admin.blade.php ENDPATH**/ ?>