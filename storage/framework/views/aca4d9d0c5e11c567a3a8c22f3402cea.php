                ...
                <div class="col-3 col-lg-auto">
                    <ul class="list-unstyled d-flex m-0">
                        ...
                        <li class="d-none d-lg-block">
                            ...
                            <a class="text-uppercase mx-3" href="#">Chào <?php echo e(session('fullname')); ?></a>
                            ...
                            <?php else: ?>
                            <a class="" href="<?php echo e(url('/dang-nhap')); ?>">LOGIN</a>
                            <?php endif; ?>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="product-item image-holder position-relative">
                                <a href="#">
                                    ...
                                    <img src="<?php echo e(asset($product->product_img)); ?>"
                                        alt="Sản phẩm <?php echo e($product->product_name); ?>" class="product-image img-fluid">
                                </a>
                                ...
                                <div class="product-content">
                                    <h5 class="element-title text-uppercase fs-5 mt-3">
                                        <a href="index.html"><?php echo e($product->product_name); ?></a>
                                    </h5>
                                    <a onclick="addToCart('<?php echo e($product->product_name); ?>', <?php echo e($product->product_price); ?>, '<?php echo e(asset($product->product_img)); ?>')"
...
</html><?php /**PATH C:\xampp\htdocs\laravel-tutorial\resources\views/viewsp.blade.php ENDPATH**/ ?>