...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <a href="<?php echo e(url('/')); ?>" class="btn-icon btn-back" title="Quay lại trang chủ">
        ...
        <div class="product-detail">
            ...
            <div class="product-info col-md-6">
                ...
                <p class="product-price">Giá ưu đãi: <span><?php echo e(number_format($product->product_price, 0, ',', '.')); ?>,000
                        VNĐ</span></p>
                <p class="product-description"><strong>Mô Tả:</strong> <?php echo e($product->product_des); ?></p>
                <div class="product-actions">
                    <!-- Add to Cart Button with Icon -->
                    <a href="<?php echo e(route('cart.add', ['id' => $product->product_ID])); ?>" class="btn-icon btn-add-to-cart"
                        title="Thêm vào giỏ">
        ...
        <div class="reviews-section">
            <div class="reviews-left">
                ...
                <div class="review-card">
                    <div class="review-author">
                        <strong><?php echo e($review->user ? $review->user->fullname : 'Người dùng không xác định'); ?></strong>
                    </div>
                    <div class="review-rating">
                        <?php for($i = 1; $i <= 5; $i++): ?> <i
                            class="fa fa-star <?php echo e($i <= $review->rating ? 'text-warning' : 'text-muted'); ?>"></i>
                            <?php endfor; ?>
                    </div>
                    ...
                    <?php endif; ?>
                    <p class="review-date">Đánh giá vào: <?php echo e($review->created_at->format('d-m-Y')); ?></p>
                </div>
            ...
            <div class="reviews-right">
                ...
                <form action="<?php echo e(route('product.submitReview', ['id' => $product->product_ID])); ?>" method="POST"
    ...
    <div class="related-products">
        ...
        <div class="related-products-list">
            ...
            <div class="related-product-item">
                <a href="<?php echo e(route('product.detail', ['id' => $related->product_ID])); ?>" class="text-decoration-none">
                    <div class="product-card">
                        <img src="<?php echo e(asset($related->product_img)); ?>" alt="<?php echo e($related->product_name); ?>"
                            class="img-fluid rounded mb-3">
                        <h3 class="product-name"><?php echo e($related->product_name); ?></h3>
                        <p class="product-price"><?php echo e(number_format($related->product_price, 0, ',', '.')); ?>,000 VNĐ</p>
                    </div>
                </a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\22662051_NguyenThiNgocVy\22662051_NguyenThiNgocVy_PhanCode\resources\views/product_view_detail.blade.php ENDPATH**/ ?>